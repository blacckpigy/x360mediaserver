...
//	public UPNPListener(File descriptionFile) throws InvalidDescriptionException
//	{
//		this(null, null);
//		loadDescription(descriptionFile);
//	}
//
//	public UPNPListener(String descriptionFileName) throws InvalidDescriptionException
//	{
...
//    {
//        rootNode = descNode;
//        deviceNode = descNode.getNode(UPNPListener.ELEM_NAME);
//        if (deviceNode == null)
...
//			deviceNode = rootNode.getNode(UPNPListener.ELEM_NAME);
//			if (deviceNode == null)
//				throw new InvalidDescriptionException(Description.NOROOTDEVICE_EXCEPTION);
//		}
...
//			if (UPNPListener.isDeviceNode(node) == false)
//				continue;
//			UPNPListener dev = new UPNPListener(node);
//			devList.add(dev);
//		} 
//		return devList;
//	}
...
//
	...
	Advertiser adv;
	private void setAdvertiser(Advertiser adve) 
	{
		adv=adve;
	}
