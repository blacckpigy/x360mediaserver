...
public class HTTPServerList extends Vector
{
    ...
    public boolean open(int port)
    {
         ...
         * String bindAddr = HostInterface.getHostAddress(n); HTTPServer httpServer = new
         * HTTPServer(); if (httpServer.open(bindAddr, port) == false) { close(); clear(); return
         * false; } add(httpServer); } return true;
         */
    }
