...
public class Device implements org.cybergarage.http.HTTPRequestListener, SearchListener
{
    ...
    /**
     * Add a Device to device without checking for duplicate or syntax error. This method set or
     * reset the root node of the Device and itself
     * 
     * @param d
    ...
    public void addDevice(Device d)
    {
        ...
        {
            deviceListNode = new Node(ServiceList.ELEM_NAME);
    ...
    /**
     * @param inets
     *            The IP that will be used for binding the SSDP service. Use <code>null</code> to
...
/*
 * public void output(PrintWriter ps) { ps.println("deviceType = " + getDeviceType());
 * ps.println("freindlyName = " + getFriendlyName()); ps.println("presentationURL = " +
 * getPresentationURL()); DeviceList devList = getDeviceList(); ps.println("devList = " +
 * devList.size()); ServiceList serviceList = getServiceList(); ps.println("serviceList = " +
 * serviceList.size()); IconList iconList = getIconList(); ps.println("iconList = " +
 * iconList.size()); } public void print() { PrintWriter pr = new PrintWriter(System.out);
 * output(pr); pr.flush(); }
 */
